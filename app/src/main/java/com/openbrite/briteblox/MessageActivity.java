...
public class MessageActivity extends Activity {
    ...
    private Button send;
    private Button gotoWearable;
    public TextView connectedTo;
    public CheckBox continueRun;
    private Handler myHandler = new Handler();
    private boolean runContinue = false;
    private long timerDelay = 3000; //milliseconds
...
//        this.requestWindowFeature(Window.FEATURE_NO_TITLE);
        ...
        DirectDrive.setBaseContext(getBaseContext());
        MyApp.initialize();
        ...
        gotoWearable = (Button) findViewById(R.id.btnWearable);
    ...
    private void initApp() {
        ...
        gotoWearable.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(ctx, WearableActivity.class));
            }
        });
        ...
        send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (started) {
                    ...
                    if (continueRun.isChecked() && runContinue == false) {
